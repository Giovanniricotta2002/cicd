...
UPDATE om_version SET om_version = '4.0.1' WHERE exists(SELECT 1 FROM om_version) = true;
INSERT INTO om_version
SELECT ('4.0.1') WHERE exists(SELECT 1 FROM om_version) = false;

--
-- START — [#8797] Modification des données techniques en contexte contentieux
--

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'),'donnees_techniques_contexte_ctx_modifier_bypass',(SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR TECHNIQUE ET FONCTIONNEL')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'donnees_techniques_contexte_ctx_modifier_bypass' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR TECHNIQUE ET FONCTIONNEL')
    );

--
-- END — [#8797] Modification des données techniques en contexte contentieux
--

--
-- START — [#8795] Champs de fusion plaignants
--
...
--Coordonnées du plaignant principal
[nom_plaignant_principal]
[civilite_plaignant_principal]
[nom_particulier_plaignant_principal]
[prenom_particulier_plaignant_principal]
...
[nom_plaignant_1](jusqu''à 5)
[civilite_plaignant_1](jusqu''à 5)
[nom_particulier_plaignant_1](jusqu''à 5)
[prenom_particulier_plaignant_1](jusqu''à 5)
...
--
-- END — [#8795] Champs de fusion plaignants
--
