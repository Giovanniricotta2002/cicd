...
class phase_gen extends om_dbform {

    protected $_absolute_class_name = "phase";

    var $table = "phase";
    var $clePrimaire = "phase";
    var $typeCle = "N";
    ...
    function setType(&$form, $maj) {
        ...
        if ($maj == 1 || $crud == 'update') {
            $form->setType("phase", "hiddenstatic");
            $form->setType("code", "text");
            if ($this->f->isAccredited(array($this->table."_modifier_validite", $this->table, ))) {
                $form->setType("om_validite_debut", "date");
            } else {
    ...
    function cleSecondaire($id, &$dnu1 = null, $val = array(), $dnu2 = null) {
        ...
        $this->rechercheTable($this->f->db, "evenement", "phase", $id);
    }
