<?php
/**
 * LISTING - Alerte Visite
 *
 * Le listing 'Alerte Visite' permet d'afficher les même dossiers que 
...
//
$conf = $om_widget->get_config_dossier_contentieux_alerte_visite($params);

/**
 * Configuration du listing
 */
// Titre de la page
$ent = _("contentieux")." -> "._("Alerte Visite");
//
