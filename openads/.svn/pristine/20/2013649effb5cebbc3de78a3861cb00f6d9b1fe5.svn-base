...
class moyen_retenu_juge_gen extends om_dbform {

    protected $_absolute_class_name = "moyen_retenu_juge";

    var $table = "moyen_retenu_juge";
    var $clePrimaire = "moyen_retenu_juge";
    var $typeCle = "N";
    ...
    function setType(&$form, $maj) {
        ...
        if ($maj == 0 || $crud == 'create') {
            $form->setType("moyen_retenu_juge", "hidden");
        ...
        if ($maj == 1 || $crud == 'update') {
            $form->setType("moyen_retenu_juge", "hiddenstatic");
            $form->setType("code", "text");
            $form->setType("libelle", "text");
            $form->setType("description", "textarea");
            if ($this->f->isAccredited(array($this->table."_modifier_validite", $this->table, ))) {
        ...
        // MODE CONSULTER
        if ($maj == 3 || $crud == 'read') {
            $form->setType("moyen_retenu_juge", "static");
    ...
    function cleSecondaire($id, &$dnu1 = null, $val = array(), $dnu2 = null) {
        ...
        $this->rechercheTable($this->f->db, "lien_donnees_techniques_moyen_retenu_juge", "moyen_retenu_juge", $id);
    }
