...
UPDATE om_version SET om_version = '4.2.0' WHERE exists(SELECT 1 FROM om_version) = true;
INSERT INTO om_version
SELECT ('4.2.0') WHERE exists(SELECT 1 FROM om_version) = false;

--
-- BEGIN / [#8841] Module de simulation des taxes
--

-- Ajout des neuf cas d'éxonérations facultatifs dans la table de paramètrage
-- des taxes

-- part régionale
ALTER TABLE taxe_amenagement
ADD COLUMN tx_exo_facul_1_reg numeric NULL,
ADD COLUMN tx_exo_facul_2_reg numeric NULL,
ADD COLUMN tx_exo_facul_3_reg numeric NULL,
ADD COLUMN tx_exo_facul_4_reg numeric NULL,
ADD COLUMN tx_exo_facul_5_reg numeric NULL,
ADD COLUMN tx_exo_facul_6_reg numeric NULL,
ADD COLUMN tx_exo_facul_7_reg numeric NULL,
ADD COLUMN tx_exo_facul_8_reg numeric NULL,
ADD COLUMN tx_exo_facul_9_reg numeric NULL;
...
-- part départementale
ALTER TABLE taxe_amenagement
ADD COLUMN tx_exo_facul_1_depart numeric NULL,
ADD COLUMN tx_exo_facul_2_depart numeric NULL,
ADD COLUMN tx_exo_facul_3_depart numeric NULL,
ADD COLUMN tx_exo_facul_4_depart numeric NULL,
ADD COLUMN tx_exo_facul_5_depart numeric NULL,
ADD COLUMN tx_exo_facul_6_depart numeric NULL,
ADD COLUMN tx_exo_facul_7_depart numeric NULL,
ADD COLUMN tx_exo_facul_8_depart numeric NULL,
ADD COLUMN tx_exo_facul_9_depart numeric NULL;
...
-- part communale
ALTER TABLE taxe_amenagement
ADD COLUMN tx_exo_facul_1_comm numeric NULL,
ADD COLUMN tx_exo_facul_2_comm numeric NULL,
ADD COLUMN tx_exo_facul_3_comm numeric NULL,
ADD COLUMN tx_exo_facul_4_comm numeric NULL,
ADD COLUMN tx_exo_facul_5_comm numeric NULL,
ADD COLUMN tx_exo_facul_6_comm numeric NULL,
ADD COLUMN tx_exo_facul_7_comm numeric NULL,
ADD COLUMN tx_exo_facul_8_comm numeric NULL,
ADD COLUMN tx_exo_facul_9_comm numeric NULL;
...
-- Ajout des neuf cas d'exonérations facultatifs dans la table des CERFA et des
-- données techniques

-- CERFA
ALTER TABLE cerfa
ADD COLUMN exo_facul_1 boolean DEFAULT false,
ADD COLUMN exo_facul_2 boolean DEFAULT false,
ADD COLUMN exo_facul_3 boolean DEFAULT false,
ADD COLUMN exo_facul_4 boolean DEFAULT false,
ADD COLUMN exo_facul_5 boolean DEFAULT false,
ADD COLUMN exo_facul_6 boolean DEFAULT false,
ADD COLUMN exo_facul_7 boolean DEFAULT false,
ADD COLUMN exo_facul_8 boolean DEFAULT false,
ADD COLUMN exo_facul_9 boolean DEFAULT false;
...
-- Ajout du montant liquidé de la redevance archéologique préventive (RAP)
ALTER TABLE dossier ADD COLUMN tax_mtn_rap numeric NULL;
COMMENT ON COLUMN dossier.tax_mtn_rap IS 'Montant liquidé de la redevance archéologique préventive (RAP)';


-- Ajout du taux de la RAP dans la table de paramètrage des taxes
ALTER TABLE taxe_amenagement ADD COLUMN tx_rap numeric NOT NULL;
COMMENT ON COLUMN taxe_amenagement.tx_rap IS 'Taux de la redevance d''archéologie préventive par m²';


-- /!\ Ne pas modifier les commandes SQL au-dessus de cette limite /!\


-- Ajout des neuf cas d'exonération de plein droit pour la TA, dans la table
-- cerfa et donnees_techniques

-- CERFA
ALTER TABLE cerfa
ADD COLUMN exo_ta_1 boolean DEFAULT false,
ADD COLUMN exo_ta_2 boolean DEFAULT false,
ADD COLUMN exo_ta_3 boolean DEFAULT false,
ADD COLUMN exo_ta_4 boolean DEFAULT false,
ADD COLUMN exo_ta_5 boolean DEFAULT false,
ADD COLUMN exo_ta_6 boolean DEFAULT false,
ADD COLUMN exo_ta_7 boolean DEFAULT false,
ADD COLUMN exo_ta_8 boolean DEFAULT false,
ADD COLUMN exo_ta_9 boolean DEFAULT false;
...
-- Ajout des huit cas d'exonération de plein droit pour la RAP, dans la table
-- cerfa et donnees_techniques

-- CERFA
ALTER TABLE cerfa
ADD COLUMN exo_rap_1 boolean DEFAULT false,
ADD COLUMN exo_rap_2 boolean DEFAULT false,
ADD COLUMN exo_rap_3 boolean DEFAULT false,
ADD COLUMN exo_rap_4 boolean DEFAULT false,
ADD COLUMN exo_rap_5 boolean DEFAULT false,
ADD COLUMN exo_rap_6 boolean DEFAULT false,
ADD COLUMN exo_rap_7 boolean DEFAULT false,
ADD COLUMN exo_rap_8 boolean DEFAULT false;
...
-- Ajout des montants des exonérations à saisir dans la table cerfa et
-- donnees_techniques

-- CERFA
ALTER TABLE cerfa 
ADD COLUMN mtn_exo_ta_part_commu boolean DEFAULT false,
ADD COLUMN mtn_exo_ta_part_depart boolean DEFAULT false,
ADD COLUMN mtn_exo_ta_part_reg boolean DEFAULT false,
ADD COLUMN mtn_exo_rap boolean DEFAULT false;
...
-- Données techniques
ALTER TABLE donnees_techniques 
ADD COLUMN mtn_exo_ta_part_commu numeric NULL,
ADD COLUMN mtn_exo_ta_part_depart numeric NULL,
ADD COLUMN mtn_exo_ta_part_reg numeric NULL,
ADD COLUMN mtn_exo_rap numeric NULL;
...
-- Ajout de la requête rapport_instruction
...
-- Ajout de la requête de consultation
...
-- Ajout de la requête instruction
...
-- Modification des commentaires des montants des taxes dans la table dossier
...
-- Ajout des montants sans exonération sur le dossier
ALTER TABLE dossier ADD COLUMN tax_mtn_part_commu_sans_exo numeric NULL;
ALTER TABLE dossier ADD COLUMN tax_mtn_part_depart_sans_exo numeric NULL;
ALTER TABLE dossier ADD COLUMN tax_mtn_part_reg_sans_exo numeric NULL;
ALTER TABLE dossier ADD COLUMN tax_mtn_total_sans_exo numeric NULL;
ALTER TABLE dossier ADD COLUMN tax_mtn_rap_sans_exo numeric NULL;
...
-- Ajout des permissions d'accès au paramétrage des taxes
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'taxe_amenagement', (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR TECHNIQUE ET FONCTIONNEL')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'taxe_amenagement' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR TECHNIQUE ET FONCTIONNEL')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'taxe_amenagement_tab', (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'taxe_amenagement_tab' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'taxe_amenagement_consulter', (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'taxe_amenagement_consulter' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'taxe_amenagement_ajouter', (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'taxe_amenagement_ajouter' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'taxe_amenagement_modifier', (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'taxe_amenagement_modifier' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'taxe_amenagement_supprimer', (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'taxe_amenagement_supprimer' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
    );


-- Ajout des permissions d'accès à la simulation des taxes
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR TECHNIQUE ET FONCTIONNEL')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR TECHNIQUE ET FONCTIONNEL')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'INSTRUCTEUR')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'INSTRUCTEUR')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'DIVISIONNAIRE')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'DIVISIONNAIRE')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'CHEF DE SERVICE')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'CHEF DE SERVICE')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'INSTRUCTEUR SERVICE')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'INSTRUCTEUR SERVICE')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'INSTRUCTEUR POLYVALENT COMMUNE')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'INSTRUCTEUR POLYVALENT COMMUNE')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'INSTRUCTEUR POLYVALENT')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'INSTRUCTEUR POLYVALENT')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET UNIQUE')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET UNIQUE')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'DIRECTION CONSULTATION')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'DIRECTION CONSULTATION')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'DIRECTION INFRACTION')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'DIRECTION INFRACTION')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'DIRECTION RECOURS')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'DIRECTION RECOURS')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'ASSISTANTE')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'ASSISTANTE')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'CHEF DE SERVICE CONTENTIEUX')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'CHEF DE SERVICE CONTENTIEUX')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'JURISTE')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'JURISTE')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'TECHNICIEN')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'TECHNICIEN')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'RESPONSABLE DIVISION INFRACTION')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'RESPONSABLE DIVISION INFRACTION')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_instruction_simulation_taxes', (SELECT om_profil FROM om_profil WHERE libelle = 'VISUALISATION DA et DI')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_instruction_simulation_taxes' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'VISUALISATION DA et DI')
    );

--
-- END / [#8841] Module de simulation des taxes
--

--
-- BEGIN / [#8825] Gestion des champs contentieux des CERFA et affichage des données techniques 
--

ALTER TABLE cerfa ALTER COLUMN ctx_objet_recours SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_moyen_souleve SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_moyen_retenu_juge SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_reference_sagace SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_nature_travaux_infra_om_html SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_synthese_nti SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_article_non_resp_om_html SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_synthese_anr SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_reference_parquet SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_element_taxation SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_infraction SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_regularisable SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_reference_courrier SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_date_audience SET DEFAULT FALSE;
ALTER TABLE cerfa ALTER COLUMN ctx_date_ajournement SET DEFAULT FALSE;

--
-- END / [#8825] Gestion des champs contentieux des CERFA et affichage des données techniques
--

--
-- BEGIN / [#8824] Problème de droit pour le profil GUICHET SUIVI
--

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'document_numerise_ajouter_bypass', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
...
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'document_numerise_supprimer_bypass', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
...
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'document_numerise_modifier_bypass', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
...
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'document_numerise_tab', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
...
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_contrainte_supprimer_bypass', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_contrainte_supprimer_bypass' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_contrainte_modifier_bypass', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_contrainte_modifier_bypass' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_contrainte_ajouter_bypass', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_contrainte_ajouter_bypass' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_contrainte', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_contrainte' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
    );
...
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'document_numerise_ajouter', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
...
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'document_numerise_modifier', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'document_numerise_modifier' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'document_numerise_supprimer', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'document_numerise_supprimer' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
    );

DELETE FROM om_droit WHERE libelle = 'document_numerise' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI');


INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_contrainte_ajouter', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_contrainte_ajouter' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_contrainte_modifier', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_contrainte_modifier' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_contrainte_supprimer', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_contrainte_supprimer' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
    );

DELETE FROM om_droit WHERE libelle = 'dossier_contrainte' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI');

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'dossier_contrainte_consulter', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'dossier_contrainte_consulter' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
    );

INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'document_numerise_consulter', (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
WHERE
    NOT EXISTS (
        SELECT om_droit FROM om_droit WHERE libelle = 'document_numerise_consulter' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'GUICHET ET SUIVI')
    );

--
-- END / [#8824] Problème de droit pour le profil GUICHET SUIVI
--
