<?php
/**
 * LISTING - Consultations 'Tous les retours'
 *
 * Le listing Consultations 'Tous les retours' permet d'afficher la même liste
 * de dossiers que le widget 'Retours de consultation' avec le filtre=aucun.
...
//
$ent = _("instruction")." -> "._("consultations")." -> "._("tous les retours");
...
$tab_actions['left']['consulter'] = array(
    'lien' => ''.OM_ROUTE_FORM.'&direct_link=true&obj=dossier_instruction&amp;action=3&amp;direct_field=dossier&direct_form=consultation&direct_action=3&direct_idx=',
    'id' => '',
 ...
 */
// Si la collectivité de l'utilisateur est de niveau mono
// alors on n'affiche pas le champ recherche collectivité
if ($f->isCollectiviteMono($_SESSION['collectivite']) === true) {
