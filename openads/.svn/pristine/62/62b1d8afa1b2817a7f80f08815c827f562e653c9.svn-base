...
UPDATE om_version SET om_version = '4.13.0' WHERE exists(SELECT 1 FROM om_version) = true;
INSERT INTO om_version
SELECT ('4.13.0') WHERE exists(SELECT 1 FROM om_version) = false;

--
-- BEGIN / [#9305] Import CSV spécifique des bibles
--

-- Ajout de la permission de manipuler les requêtes mémorisées par le profil
-- ADMINISTRATEUR GENERAL
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'reqmo', (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
WHERE NOT EXISTS (
    SELECT om_droit FROM om_droit WHERE libelle = 'reqmo' AND om_profil = (SELECT om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR GENERAL')
);

--
-- END / [#9305] Import CSV spécifique des bibles
--

--
-- BEGIN / [#9303] Ajout des champs de fusion du taux communal de la TA pour les 20 secteurs
--
...
--
-- END / [#9303] Ajout des champs de fusion du taux communal de la TA pour les 20 secteurs
--

--
-- BEGIN / [#9321] Ajout du suivi de numérisation
--

-- Création de la table num_bordereau
...
-- Création de la table num_dossier
...
-- tous les droits
INSERT INTO om_droit (om_droit, libelle, om_profil) 
SELECT nextval('om_droit_seq'), 'num_bordereau', om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR TECHNIQUE ET FONCTIONNEL'
;
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'num_dossier', om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR TECHNIQUE ET FONCTIONNEL'
;
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'num_dossier_recuperation', om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR TECHNIQUE ET FONCTIONNEL'
;
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'num_dossier_a_attribuer', om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR TECHNIQUE ET FONCTIONNEL'
;
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'num_dossier_a_numeriser', om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR TECHNIQUE ET FONCTIONNEL'
;
INSERT INTO om_droit (om_droit, libelle, om_profil)
SELECT nextval('om_droit_seq'), 'num_dossier_traite', om_profil FROM om_profil WHERE libelle = 'ADMINISTRATEUR TECHNIQUE ET FONCTIONNEL'
;

-- CELLULE SUIVI
-- bordereau
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_bordereau_tab', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_bordereau_consulter', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_bordereau_ajouter', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_bordereau_modifier_dossier', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
-- dossier
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_recuperation', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_tab', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_consulter', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_copier', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_a_attribuer_tab', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_a_attribuer_consulter', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_a_attribuer_modifier', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_a_numeriser_tab', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_a_numeriser_consulter', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_a_numeriser_modifier', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_traite_tab', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_traite_consulter', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_traite_modifier', om_profil FROM om_profil WHERE libelle = 'CELLULE SUIVI';

-- QUALIFICATEUR
-- bordereau
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_bordereau_tab', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_bordereau_consulter', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_bordereau_ajouter', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_bordereau_modifier_dossier', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
-- dossier
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_recuperation', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_tab', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_consulter', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_copier', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_a_attribuer_tab', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_a_attribuer_consulter', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_a_attribuer_modifier', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_a_numeriser_tab', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_a_numeriser_consulter', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_a_numeriser_modifier', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_traite_tab', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_traite_consulter', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';
INSERT INTO om_droit (om_droit, libelle, om_profil) SELECT nextval('om_droit_seq'),'num_dossier_traite_modifier', om_profil FROM om_profil WHERE libelle = 'QUALIFICATEUR';

--
-- END / [#9321] Ajout du suivi de numérisation
--

--
-- BEGIN / [#9302] Gestion des versions de clôture des dossiers d'instruction 
--

-- Ajout de la colonne dossier_autorisation.numero_version_clos
ALTER TABLE dossier_autorisation ADD COLUMN numero_version_clos integer;
COMMENT ON COLUMN dossier_autorisation.numero_version_clos IS 'Numéro de version de clôture du dossier d''autorisation';

-- Ajout de la colonne dossier.version_clos
ALTER TABLE dossier ADD COLUMN version_clos integer;
...
UPDATE dossier_autorisation SET numero_version_clos = numero_version;
UPDATE dossier SET version_clos = version;

--
-- END / [#9302] Gestion des versions de clôture des dossiers d'instruction 
--

--
-- BEGIN / [#9311] Mise à jour des données techniques du DA suite à l'instruction
-- de DI en parallèle
--

-- Ajout de la colonne initial_dt
ALTER TABLE dossier ADD initial_dt text DEFAULT '{}';
...
--
-- END / [#9311] Mise à jour des données techniques du DA suite à l'instruction
-- de DI en parallèle
--
