...
Ajouter cerfa
    ...
    ${cerfa} =  Get Text  css=div.form-content span#cerfa
    # On le retourne
    [Return]  ${cerfa}
...
Saisir cerfa
    ...
    Si "dia_mod_cess_commi_mnt" existe dans "${values}" on execute "Set Checkbox" dans le formulaire
    ...
    Si "dia_mod_cess_prix_vente_mob_num" existe dans "${values}" on execute "Set Checkbox" dans le formulaire
    Si "dia_mod_cess_prix_vente_cheptel_num" existe dans "${values}" on execute "Set Checkbox" dans le formulaire
    Si "dia_mod_cess_prix_vente_recol_num" existe dans "${values}" on execute "Set Checkbox" dans le formulaire
    Si "dia_mod_cess_prix_vente_autre_num" existe dans "${values}" on execute "Set Checkbox" dans le formulaire
    Si "dia_su_co_sol_num" existe dans "${values}" on execute "Set Checkbox" dans le formulaire
    Si "dia_su_util_hab_num" existe dans "${values}" on execute "Set Checkbox" dans le formulaire
    Si "dia_mod_cess_mnt_an_num" existe dans "${values}" on execute "Set Checkbox" dans le formulaire
