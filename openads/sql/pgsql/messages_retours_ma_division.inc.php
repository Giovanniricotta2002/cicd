<?php
/**
 * LISTING - Messages 'Retours de ma division'
 *
 * Le listing Messages 'Retours de ma division' permet d'afficher la même
 * liste des dossiers que le widget 'Retours de messages' avec le
...
//
$ent = _("instruction")." -> "._("messages")." -> "._("messages de ma division");
...
$tab_actions['left']['consulter'] = array(
    'lien' => ''.OM_ROUTE_FORM.'&direct_link=true&obj=dossier_instruction_tous_encours&amp;action=3&amp;direct_field=dossier&direct_form=dossier_message&direct_action=3&direct_idx=',
    'id' => '',
