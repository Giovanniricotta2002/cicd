 ...
 *
 * @package openads
 * @version SVN : $Id: messages_contentieux_retours_ma_division.inc.php 6565 2017-04-21 16:14:15Z softime $
 */
...
//
$ent = _("contentieux")." -> "._("messages")." -> "._("messages de ma division");
