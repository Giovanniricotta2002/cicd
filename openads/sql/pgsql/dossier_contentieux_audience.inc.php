<?php
/**
 * LISTING - Les audiences
 *
 * Le listing 'Les audiences' permet d'afficher les même dossiers que 
 * le widget 'Les audiences' sans la limite de 5 enregistrements. Aucune 
 * entrée de menu ne permet d'accéder à ce listing, c'est un lien depuis le
 * widget qui nous permet d'arriver sur ce listing.
 *
 * @package openads
 * @version SVN : $Id: dossiers_audiances.inc.php 5208 2015-09-23 21:32:51Z fmichon $
 */
...
//
$conf = $om_widget->get_config_dossier_contentieux_audience($params);

/**
 * Configuration du listing
 */
// Titre de la page
$ent = _("contentieux")." -> "._("Les audiences");
//
