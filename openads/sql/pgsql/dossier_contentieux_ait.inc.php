 ...
 * LISTING - Les AIT
 *
 * Le listing 'Les AIT' permet d'afficher les même dossiers que 
 * le widget 'Les AIT' sans la limite de 5 enregistrements. Aucune 
...
//
$conf = $om_widget->get_config_dossier_contentieux_ait($params);
