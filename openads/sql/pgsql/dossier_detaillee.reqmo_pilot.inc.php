...
$reqmo['libelle']=_("Liste detaillee des dossiers");
...
// On liste seulement les types de DA dont l'utilisateur connecté a le groupe
// lié et dont le type d'affichage est celui des dossiers ADS
...
//Traduction des libellés de colonne
_("reference_dossier");
_("date_depot");
