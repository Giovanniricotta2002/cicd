...
Depuis le contexte motif de consultation
    ...
    Depuis le listing  motif_consultation
    # On recherche l'enregistrement
    Input Text  css=#adv-search-classic-fields input.champFormulaire  ${motif_consultation}
...
Saisir motif de consultation
    ...
    Si "delai_type" existe dans "${values}" on execute "Select From List By Label" dans le formulaire
