...
function getViewerConfiguration() {
  return {
    ...
    toolbar: {
      ...
      selectTool: document.getElementById('cursorSelectTool'),
      handTool: document.getElementById('cursorHandTool'),
          ...
          switch (_context7.prev = _context7.next) {
            ...
            case 3:
              ...
              if (parent.window.pdfjs_content_b64) {
                parameters.data = parent.window.pdfjs_content_b64;
              }
...
var Toolbar = function () {
  ...
  _createClass(Toolbar, [{
    ...
    value: function _bindListeners() {
      ...
      items.firstPage.addEventListener('click', function () {
        eventBus.dispatch('firstpage', { source: self });
      });
      items.lastPage.addEventListener('click', function () {
        eventBus.dispatch('lastpage', { source: self });
      });
      ...
      items.selectTool.addEventListener('click', function () {
        eventBus.dispatch('switchcursortool', { source: self, tool: _pdf_cursor_tools.CursorTool.SELECT });
      });
      items.handTool.addEventListener('click', function () {
        eventBus.dispatch('switchcursortool', { source: self, tool: _pdf_cursor_tools.CursorTool.HAND });
      });
    ...
    value: function _bindCursorToolsListener(buttons) {
      this.eventBus.on('cursortoolchanged', function (evt) {
        buttons.selectTool.classList.remove('toggled');
        buttons.handTool.classList.remove('toggled');
        switch (evt.tool) {
          case _pdf_cursor_tools.CursorTool.SELECT:
            buttons.selectTool.classList.add('toggled');
            break;
          case _pdf_cursor_tools.CursorTool.HAND:
            buttons.handTool.classList.add('toggled');
            break;
        }
      });
    }
