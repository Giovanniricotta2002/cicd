<?php
//$Id$ 
//gen openMairie le 23/12/2022 11:19
...
class departement_gen extends om_dbform {
    ...
    function setType(&$form, $maj) {
        ...
        if ($maj == 0 || $crud == 'create') {
            $form->setType("departement", "hidden");
        ...
        if ($maj == 1 || $crud == 'update') {
            $form->setType("departement", "hiddenstatic");
            $form->setType("dep", "text");
            $form->setType("reg", "text");
            $form->setType("cheflieu", "text");
            $form->setType("tncc", "text");
        ...
        // MODE CONSULTER
        if ($maj == 3 || $crud == 'read') {
            $form->setType("departement", "static");
    ...
    function cleSecondaire($id, &$dnu1 = null, $val = array(), $dnu2 = null) {
        ...
        $this->rechercheTable($this->f->db, "lien_habilitation_tiers_consulte_departement", "departement", $id);
    }
