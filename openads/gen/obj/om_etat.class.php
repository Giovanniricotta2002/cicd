...
class om_etat_gen extends om_dbform {
    ...
    function cleSecondaire($id, &$dnu1 = null, $val = array(), $dnu2 = null) {
        ...
        // Verification de la cle secondaire : motif_consultation
        $this->rechercheTable($this->f->db, "motif_consultation", "om_etat", $id);
        // Verification de la cle secondaire : service
        $this->rechercheTable($this->f->db, "service", "edition", $id);
    }
