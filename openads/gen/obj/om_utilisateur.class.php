...
class om_utilisateur_gen extends om_dbform {
    ...
    function cleSecondaire($id, &$dnu1 = null, $val = array(), $dnu2 = null) {
        ...
        $this->rechercheTable($this->f->db, "instructeur", "om_utilisateur", $id);
        // Verification de la cle secondaire : lien_om_utilisateur_tiers_consulte
        $this->rechercheTable($this->f->db, "lien_om_utilisateur_tiers_consulte", "om_utilisateur", $id);
        // Verification de la cle secondaire : lien_service_om_utilisateur
        $this->rechercheTable($this->f->db, "lien_service_om_utilisateur", "om_utilisateur", $id);
    }
