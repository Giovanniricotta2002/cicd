...
class type_habilitation_tiers_consulte_gen extends om_dbform {

    protected $_absolute_class_name = "type_habilitation_tiers_consulte";

    var $table = "type_habilitation_tiers_consulte";
    var $clePrimaire = "type_habilitation_tiers_consulte";
    var $typeCle = "N";
    ...
    function setType(&$form, $maj) {
        ...
        if ($maj == 1 || $crud == 'update') {
            $form->setType("type_habilitation_tiers_consulte", "hiddenstatic");
            $form->setType("code", "text");
            $form->setType("description", "textarea");
            $form->setType("libelle", "text");
            if ($this->f->isAccredited(array($this->table."_modifier_validite", $this->table, ))) {
        ...
        // MODE CONSULTER
        if ($maj == 3 || $crud == 'read') {
            $form->setType("type_habilitation_tiers_consulte", "static");
    ...
    function cleSecondaire($id, &$dnu1 = null, $val = array(), $dnu2 = null) {
        ...
        $this->rechercheTable($this->f->db, "evenement_type_habilitation_tiers_consulte", "type_habilitation_tiers_consulte", $id);
        // Verification de la cle secondaire : habilitation_tiers_consulte
        $this->rechercheTable($this->f->db, "habilitation_tiers_consulte", "type_habilitation_tiers_consulte", $id);
    }
