...
class specialite_tiers_consulte_gen extends om_dbform {

    protected $_absolute_class_name = "specialite_tiers_consulte";

    var $table = "specialite_tiers_consulte";
    var $clePrimaire = "specialite_tiers_consulte";
    var $typeCle = "N";
    ...
    function setType(&$form, $maj) {
        ...
        if ($maj == 0 || $crud == 'create') {
            $form->setType("specialite_tiers_consulte", "hidden");
        ...
        if ($maj == 1 || $crud == 'update') {
            $form->setType("specialite_tiers_consulte", "hiddenstatic");
            $form->setType("code", "text");
            $form->setType("description", "textarea");
            $form->setType("libelle", "text");
            if ($this->f->isAccredited(array($this->table."_modifier_validite", $this->table, ))) {
        ...
        // MODE CONSULTER
        if ($maj == 3 || $crud == 'read') {
            $form->setType("specialite_tiers_consulte", "static");
    ...
    function cleSecondaire($id, &$dnu1 = null, $val = array(), $dnu2 = null) {
        ...
        $this->rechercheTable($this->f->db, "lien_habilitation_tiers_consulte_specialite_tiers_consulte", "specialite_tiers_consulte", $id);
    }
