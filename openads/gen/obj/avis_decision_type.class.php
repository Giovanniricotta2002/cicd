...
class avis_decision_type_gen extends om_dbform {

    protected $_absolute_class_name = "avis_decision_type";

    var $table = "avis_decision_type";
    var $clePrimaire = "avis_decision_type";
    var $typeCle = "N";
    ...
    function setvalF($val = array()) {
        ...
        if (!is_numeric($val['avis_decision_type'])) {
            $this->valF['avis_decision_type'] = ""; // -> requis
        } else {
    ...
    function setType(&$form, $maj) {
        ...
        if ($maj == 0 || $crud == 'create') {
            $form->setType("avis_decision_type", "hidden");
        ...
        if ($maj == 1 || $crud == 'update') {
            $form->setType("avis_decision_type", "hiddenstatic");
            $form->setType("code", "text");
            $form->setType("libelle", "text");
            $form->setType("description", "textarea");
            if ($this->f->isAccredited(array($this->table."_modifier_validite", $this->table, ))) {
        ...
        // MODE CONSULTER
        if ($maj == 3 || $crud == 'read') {
            $form->setType("avis_decision_type", "static");
    ...
    function cleSecondaire($id, &$dnu1 = null, $val = array(), $dnu2 = null) {
        ...
        $this->rechercheTable($this->f->db, "avis_decision", "avis_decision_type", $id);
    }
