 ...
 * @version SVN : $Id: om_dbform.class.php 4736 2022-11-29 09:26:03Z fmichon $
 */
...
class dbform extends om_base {
            ...
            if ($type == "upload" OR $type == "upload2" OR $type == "filestatic"
                ...
                if (($this->getVal($champ) == ""
                    ...
                    if (isset($temporary_test[0]) && $temporary_test[0] == "tmp") {
                        ...
                        //
                        $this->valF[$champ] = $this->f->storage->create($temporary_test[1], $metadata, "from_temporary", $this->table.".".$champ);
     ...
     * @return void
     */
    function getSelectOldValue(&$form, $maj, &$dnu1 = null, &$contenu = array(), $sql_by_id = "", $table = "", $val = null) {
