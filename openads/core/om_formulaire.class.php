 ...
 * @version SVN : $Id: om_formulaire.class.php 4736 2022-11-29 09:26:03Z fmichon $
 */
...
class formulaire extends om_base {
   ...
   /**
    ...
    function selecthiddenstatic($champ, $validation, $DEBUG = false) {
        if (isset($this->select) === true
            && is_array($this->select) === true
            && array_key_exists($champ, $this->select) === true
            && is_array($this->select[$champ]) === true
            && array_key_exists(0, $this->select[$champ]) === true
            && is_array($this->select[$champ][0]) === true
            && in_array($this->val[$champ], $this->select[$champ][0]) === true) {
