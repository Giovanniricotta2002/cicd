 ...
 * @version SVN : $Id: om_gen.class.php 4671 2021-01-27 23:54:02Z fmichon $
 */
...
$fields = array(';
    ...
    function _init_constraint_notnull() {
        ...
        // Les requêtes ne renvoient pas toujours le même ordre des champs
        // donc on force le tri du tableau identique peu importe la version de
        // la base de données et la locale utilisée.
        sort($this->_columns_notnull);
    }
