 ...
 * @version SVN : $Id: om_application.class.php 4736 2022-11-29 09:26:03Z fmichon $
 */
...
class application {
     ...
     * - login_and_nohtml -> permet d'authentifier l'utilisateur
    ...
    function __construct($flag = null, $right = null, $title = null) {
        ...
        if ($this->flag == "login" || $this->flag == "login_and_nohtml") {
            $this->login();
        }
            ...
            if ($valid_post == true) {
                ...
                // cas : login correct et mode == "db"
                    ...
                    if (isset($user_infos['email']) and !empty($user_infos['email'])) {
                        ...
                        // compose mail
                        $mail_title  = __("Confirmation de réinitialisation du mot de passe ".$this->get_application_name());
                        $mail_recipient = $user_infos['email'];
                        $mail_content = __("Vous avez demandé la réinitialisation de votre mot de passe ".$this->get_application_name()." pour l'identifiant")." : ".$login."<br>";
                        ...
                        $mail_content .= "<br><br>Pour des raisons de sécurité, le lien ci-dessus expire dans un délai de 1 heure.";
    ...
    protected function set_config__footer() {
        ...
        $footer[] = array(
            ...
            "href" => "http://docs.openmairie.org/?project=framework&version=4.10",
            "target" => "_blank",
